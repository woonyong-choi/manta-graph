export const COPY_EN = {
	...
	view: { title: "Manta Graph", openRibbon: "View the current note in Manta Graph", openCommand: "Open Manta Graph for the current note", refreshCommand: "Refresh Manta Graph", focusSearchCommand: "Focus route search", backCommand: "Navigate back in this session", forwardCommand: "Navigate forward in this session" },
	actions: {
	...
	labels: {
		...
		noSearchResults: "No matching links.", readFailed: "Manta Graph could not read the current note.",
