...
1. In **Settings → Community plugins → Browse**, find **Linked Graph Navigator**, then install and enable it.
...
3. Keep that note active and run **Open Linked Graph Navigator for the current note**. Select **Outline** to follow the links in their written order.
